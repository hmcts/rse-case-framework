...
public class MetaData {
    ...
    public enum CaseField {
        ...
        CASE_TYPE("case_type", "case_type_id"),
        STATE("state", "state"),
        CASE_REFERENCE("case_reference", "reference"),
        CREATED_DATE("created_date", "created_date"),
        LAST_MODIFIED_DATE("last_modified_date", "last_modified"),
        LAST_STATE_MODIFIED_DATE("last_state_modified_date", "last_state_modified_date"),
        SECURITY_CLASSIFICATION("security_classification", "security_classification");
